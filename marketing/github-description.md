...
Título: `v0.3.2 — Live Agent Console e modos de autonomia`

Corpo: as notas de release derivam do `CHANGELOG.md`, seção `[0.3.2]`.
...
> aqui.
>
> `0.3.2` é **estável**, e estável não quer dizer completo. As limitações
